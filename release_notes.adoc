...
Per ulteriori informazioni, consultare https://library.netapp.com/ecm/ecm_download_file/ECMLP2881273["Note sulla versione di ONTAP Tools per VMware vSphere 9.10"^].
