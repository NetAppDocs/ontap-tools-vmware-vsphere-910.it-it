...
Per eseguire l'aggiornamento ai tool ONTAP 9.10, è necessario eseguire l'appliance virtuale 9.7P1 o successiva. L'aggiornamento da una versione precedente alla 9.7P1 dell'appliance virtuale non è supportato.
