...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-resource-management.html["Documentazione VMware vSphere: Abilitare il controllo i/o dello storage"^]
